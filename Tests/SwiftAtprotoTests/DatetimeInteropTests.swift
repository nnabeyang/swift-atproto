...
struct DatetimeInteropTests {
  @Test(arguments: validDatetimes)
  func validExamplesParse(_ value: String) throws {
    _ = try Date(string: value)
  }

  @Test(arguments: invalidDatetimes)
