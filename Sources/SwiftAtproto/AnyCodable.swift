...
public struct AnyCodable {
    enum BoxType {
        ...
        var encodable: _AnyBaseBox {
            switch self {
            case let .encodable(box): box
            case let .equatable(box): box
            case let .hashable(box): box
            }
        }
        ...
        var base: Any {
            switch self {
            case let .encodable(box): box._base
            case let .equatable(box): box._base
            case let .hashable(box): box._base
            }
        }
    }
