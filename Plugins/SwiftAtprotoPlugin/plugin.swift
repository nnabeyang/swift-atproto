...
extension SwiftAtprotoPlugin: CommandPlugin {
  ...
  private func configurationFileURL(packageDirectoryURL: URL, currentDirectoryURL: URL) -> URL {
    let currentURL = currentDirectoryURL.appending(component: ".atproto.json")
